...
DEPS=dbug.h kernel.h soft_interrupts.h rtx.h system_processes.h init.h string.h process.h loader/rtx_test.h queues.h
OBJS=dbug.o kernel.o soft_interrupts.o rtx.o system_processes.o init.o string.o main.o queues.o
