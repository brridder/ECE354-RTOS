...
David's main responsibility of this project was to write the documentation for 
each part. Also, he worked in a pair programming environment to assist with the 
development of the wall clock process, the memory primitives, and priority 
primitives. Another major responsibility that David had was to come up with test 
cases that could be implemented to verify the basic functionality and edge cases 
of each part. Finally, he was very active in the debugging sessions when a new 
primitive or process was integrated into the whole system. 
