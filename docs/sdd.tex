...
\begin{table}
    ...
    \texttt{UART\_PID} & 10 \\
    \texttt{TIMER\_PID} & 11 \\
    \texttt{CRT\_DISPLAY\_PID} & 12 \\
    \texttt{KCD\_PID} & 13 \\
    \texttt{WALL\_CLOCK\_PID} & 14 \\
    \texttt{SET\_PRIORITY\_PID} & 15 \\
    \hline
    \end{tabular}
    } % center
\end{table}
...
The header file \texttt{globals.h} is used as a central storage of all
definitions that are required globally. It contains the process ID of all the
