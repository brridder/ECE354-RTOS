...
\texttt{send\_message()}, \texttt{receive\_message()}, and
\texttt{request\_memory\_block()} primitives were collected. This data can be found in Table~\ref{measurementdata}.
