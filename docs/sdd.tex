...
per specification, the entire test suite was run to verify to negative impact on 
the system. To ease the task of debugging, a very basic \texttt{printf} function 
was created which allowed decimal and hexidecimal inputs to be displayed. This 
...
functionality was not as expected. This process was not used in every part part 
one of the project as it had a separate test program written to test its 
functionality. The user process A, B, and C were used to stress test our 
operating system and verify its behaviour under load. 
