...
system. However, during the part four lab demo, two issues were
...
supervisor mode. Secondly, the current UART I-process implemention has
a possibilty of blocking on memory.
