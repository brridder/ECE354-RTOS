...
key. Finally, after initalization in Section~\ref{sec:rtx_init}, the implementation
...
\texttt{RTX\_SUCCESS}, is defined as $0$ and is used for indicating a sucess 
...
the group. Casey also handled implemenation of the test case processes
which were designed by David. Additionaly, Casey handled setting up
...
an accurate result; the average runtime for all primitives was less than a
millisecond.
